        ...
        <ScrollableFeed>
          <div>
            <div className='MessageContainer'>
              <div className={`MessageContainer__message--left`}>
                ...
                <span className='poppins_regular_400'>Welcome to our chat.Here you can chat with all our staffs & customers</span>
              </div>
            </div>
          </div>
          ...
          {messages.map((messageObj, index) => {
            return (
              ...
              <div key={index}>
                <Message user={messageObj.id === id ? "You" : messageObj.user} message={messageObj.message} classs={messageObj.id === id ? "right" : "left"} />
              </div>
            );
          })}
        </ScrollableFeed>
