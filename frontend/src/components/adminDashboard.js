...
import ChatBox from "./chatsystem/ChatBox";
      ...
      <div className="row">
          ...
          <div className="position-sticky">
            <ul className="nav flex-column">
              <li className="nav-item">
                <Link to="/admindashboard/Chatbox" className="nav-link">
                  Chat System
                </Link>
              </li>
              <li className="nav-item">
                <Link to="/admindashboard/StudentForm" className="nav-link">
                  Form
                </Link>
              </li>
            </ul>
        ...
        <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4">
          ...
          <Routes>
            ...
            <Route path="/admindashboard/StudentForm" element={<StudentForm onSave={saveStudentInfo} />} />
          </Routes>
